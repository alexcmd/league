...
import static de.wealthpilot.challenge.league.service.impl.AdvancedSchedulerTestCasesHelper.*;
import static org.junit.jupiter.api.Assertions.assertEquals;

@ExtendWith(MockitoExtension.class)
class AdvancedSchedulerServiceTest {
    ...
    void makeTest(League input, ScheduleSettings settings, Schedule expected) {
        initRepo(input);
        var scheduler = new AdvancedSchedulerService(repository);
